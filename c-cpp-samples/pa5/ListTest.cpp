...
int main(){
   ...
   for( i=1; i<=7; i++){
      cout << "F.peekNext: " << F.peekNext() << "    ";
      F.insertBefore(-i);
      cout << "F.moveNext: " << F.moveNext() << endl;
   }
   cout << "F = " << F << endl;
   cout << endl;
   ...
   cout << "If you want to set before the cursor: ";
   try{
      A.setBefore(5);
   }catch( std::range_error& e ){
      cout << e.what() << endl;
   ...
   cout << "If you want to erase before the cursor: ";
   try{
      A.eraseBefore();
   }catch( std::range_error& e ){
      cout << e.what() << endl;
   ...
   cout << "If you want to set after the cursor: ";
   try{
      A.setAfter(5);
   }catch( std::range_error& e ){
      cout << e.what() << endl;
   ...
   cout << "If you want to erase after the cursor: ";
   try{
      A.eraseAfter();
   }catch( std::range_error& e ){
      cout << e.what() << endl;
   ...
   cout << "If you want to get the front element in this List:";
   try{
      A.front();
   ...
   cout << "If you want to get the back element in this List:";
   try{
      A.back();
   }catch( std::length_error& e ){
      cout << e.what() << endl;
