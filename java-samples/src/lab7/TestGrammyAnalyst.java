...
public class TestGrammyAnalyst {
	...
	public void test1_NominationsSize() {
		assertEquals("Test nominations size", 102, grammyAnalyst.nominations.size());
	}
	...
	public void test2_GrammyMapSize() {
		assertEquals("Test grammyMap size", 83, grammyAnalyst.grammyMap.size());
	}
	@Test
	...
	public void test5_ArtistsSize() {
		assertEquals("Test artists size", 83, grammyAnalyst.artists.size());
	}
	@Test
